...
class _ExplorerContent extends StatefulWidget {
  const _ExplorerContent();

  @override
  State<_ExplorerContent> createState() => _ExplorerContentState();
}

class _ExplorerContentState extends State<_ExplorerContent> {
  final int _currentIndex = 1; // Explorer is index 1
        ...
        children: [
          ...
          NavigationBar(
            ...
            onDestinationSelected: (index) {
              ...
              // index == 1 is already here, do nothing
            },
            destinations: const [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _Tab(
                      label: 'Quran',
                      active: vm.tab == ExplorerTab.quran,
                      onTap: () => vm.setTab(ExplorerTab.quran)),
                  const SizedBox(width: 8),
                  _Tab(
                      label: 'Musique',
                      active: vm.tab == ExplorerTab.music,
                      onTap: () {
                  ...
                  _Tab(
                      label: 'Favoris',
                      active: vm.tab == ExplorerTab.favorites,
  ...
  Widget _buildTabContent(BuildContext context, ExplorerViewModel vm) {
    switch (vm.tab) {
      case ExplorerTab.quran:
        return _QuranTab(
            vm: vm, onPlay: (t) => _openPlayer(context, t, vm.quranTracks));
      case ExplorerTab.music:
        return _MusicTab(
            vm: vm, onPlay: (t) => _openPlayer(context, t, vm.musicTracks));
      case ExplorerTab.favorites:
        return _FavoritesTab(
            vm: vm, onPlay: (t, q) => _openPlayer(context, t, q));
    }
  }
}
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage(QuranService.reciters[name]!),
                            fit: BoxFit.cover,
                            onError: (_, __) {},
                          ),
                        ),
...
class _MusicTab extends StatelessWidget {
  ...
  Color _genreColor(String genre) {
    switch (genre) {
      ...
      case 'Rap':
        return AppColors.rap;
      case 'R&B':
        return AppColors.rnb;
      case 'Rock':
        return AppColors.rock;
      case 'Electro':
        return AppColors.electro;
      default:
        return AppColors.nasheed;
    }
  }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  const Text(
                      'Sélectionne un genre pour charger les morceaux',
                      style: TextStyle(
